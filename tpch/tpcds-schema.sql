...
CREATE TABLE call_center(cc_call_center_sk INTEGER,
...
CREATE TABLE catalog_page(cp_catalog_page_sk INTEGER,
...
CREATE TABLE catalog_returns(cr_returned_date_sk INTEGER,
...
CREATE TABLE catalog_sales(cs_sold_date_sk INTEGER,
...
CREATE TABLE customer(c_customer_sk INTEGER,
...
CREATE TABLE customer_address(ca_address_sk INTEGER,
...
CREATE TABLE customer_demographics(cd_demo_sk INTEGER,
		cd_gender VARCHAR,
...
CREATE TABLE date_dim(d_date_sk INTEGER,
		d_date_id VARCHAR,
		d_date DATE,
		d_month_seq INTEGER,
		d_week_seq INTEGER,
...
CREATE TABLE household_demographics(hd_demo_sk INTEGER,
...
CREATE TABLE income_band(ib_income_band_sk INTEGER,
		ib_lower_bound INTEGER,
		ib_upper_bound INTEGER);

DROP TABLE IF EXISTS inventory CASCADE;
CREATE TABLE inventory(inv_date_sk INTEGER,
		inv_item_sk INTEGER,
		inv_warehouse_sk INTEGER,
		inv_quantity_on_hand INTEGER);

DROP TABLE IF EXISTS item CASCADE;
CREATE TABLE item(i_item_sk INTEGER,
		i_item_id VARCHAR,
...
CREATE TABLE promotion(p_promo_sk INTEGER,
		p_promo_id VARCHAR,
...
CREATE TABLE reason(r_reason_sk INTEGER,
		r_reason_id VARCHAR,
		r_reason_desc VARCHAR);

DROP TABLE IF EXISTS ship_mode CASCADE;
CREATE TABLE ship_mode(sm_ship_mode_sk INTEGER,
...
CREATE TABLE store(s_store_sk INTEGER,
		s_store_id VARCHAR,
...
CREATE TABLE store_returns(sr_returned_date_sk INTEGER,
...
CREATE TABLE store_sales(ss_sold_date_sk INTEGER,
...
CREATE TABLE time_dim(t_time_sk INTEGER,
		t_time_id VARCHAR,
		t_time INTEGER,
		t_hour INTEGER,
		t_minute INTEGER,
...
CREATE TABLE warehouse(w_warehouse_sk INTEGER,
...
CREATE TABLE web_page(wp_web_page_sk INTEGER,
...
CREATE TABLE web_returns(wr_returned_date_sk INTEGER,
...
CREATE TABLE web_sales(ws_sold_date_sk INTEGER,
...
CREATE TABLE web_site(web_site_sk INTEGER,
		web_site_id VARCHAR,
